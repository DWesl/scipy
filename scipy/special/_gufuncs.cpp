...
using func_d_d1d1_t = void (*)(double, mdspan<double, dextents<ptrdiff_t, 1>, layout_stride>,
                               mdspan<double, dextents<ptrdiff_t, 1>, layout_stride>);
using func_F_F1F1_t = void (*)(complex<float>, mdspan<complex<float>, dextents<ptrdiff_t, 1>, layout_stride>,
                               mdspan<complex<float>, dextents<ptrdiff_t, 1>, layout_stride>);
using func_D_D1D1_t = void (*)(complex<double>, mdspan<complex<double>, dextents<ptrdiff_t, 1>, layout_stride>,
                               mdspan<complex<double>, dextents<ptrdiff_t, 1>, layout_stride>);

using func_f_f2f2_t = void (*)(float, mdspan<float, dextents<ptrdiff_t, 2>, layout_stride>,
                               mdspan<float, dextents<ptrdiff_t, 2>, layout_stride>);
using func_d_d2d2_t = void (*)(double, mdspan<double, dextents<ptrdiff_t, 2>, layout_stride>,
                               mdspan<double, dextents<ptrdiff_t, 2>, layout_stride>);
using func_F_F2F2_t = void (*)(complex<float>, mdspan<complex<float>, dextents<ptrdiff_t, 2>, layout_stride>,
...
PyMODINIT_FUNC PyInit__gufuncs() {
    ...
    PyObject *_lpn =
        SpecFun_NewGUFunc({static_cast<func_f_f1f1_t>(special::lpn), static_cast<func_d_d1d1_t>(special::lpn),
                           static_cast<func_F_F1F1_t>(special::lpn), static_cast<func_D_D1D1_t>(special::lpn)},
    ...
    PyObject *_lqn =
        SpecFun_NewGUFunc({static_cast<func_f_f1f1_t>(special::lqn), static_cast<func_d_d1d1_t>(special::lqn),
    ...
    PyObject *_lqmn =
        SpecFun_NewGUFunc({static_cast<func_f_f2f2_t>(special::lqmn), static_cast<func_d_d2d2_t>(special::lqmn),
    ...
    PyObject *_rctj =
        SpecFun_NewGUFunc({static_cast<func_f_f1f1_t>(special::rctj), static_cast<func_d_d1d1_t>(special::rctj)}, 2,
                          "_rctj", rctj_doc, "()->(np1),(np1)");
